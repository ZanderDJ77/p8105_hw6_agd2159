...
Creating the Bootstrap that can calculate R Squared Data over 5000 iterations, assigning the regression model `maxtemp_model` as an anonymous function:
...
Next, we will compute the log(beta1 + beta2) using 5,000 iterations, and find the confidence intervals of both bootstrapped values.
