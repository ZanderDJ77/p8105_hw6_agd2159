...
The r squared shown usinbg `broom::glance()` tells us that this simple model is highly explanatory of tmax's variance, largely carried by the strength of `tmin` as a predictor variable.
...
#For somer reason this is giving the same weather_df regression results every time, need to fix
boot_results =
  tibble(strap_number = 1:1000 ) |> 
  mutate(
    strap_sample = map(strap_number, \(i) (weather_df)),
