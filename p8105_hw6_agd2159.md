...
iterations, assigning the regression model `maxtemp_model` as an
anonymous function:
...
![](p8105_hw6_agd2159_files/figure-gfm/modelr::bootstrap%20function-1.png)<!-- -->
...
Next, we will compute the log(beta1 + beta2) using 5,000 iterations, and
find the confidence intervals of both bootstrapped values.
